...
export function SocialSkills() {
    return (
        <div className="flex flex-col justify-center">
            <main className="flex flex-col items-center justify-center w-full md:py-24">
                <div className="flex flex-col md:flex-row w-full max-w-screen-lg mx-auto">
                    {/* Imagen a la izquierda */}
                    <div className="h-auto flex justify-center w-full md:w-1/3 mb-6 md:mb-0">
                        <img
                            className="w-30 sm:w-32 md:w-64 lg:w-98 h-auto object-cover rounded-lg shadow-lg"
                            src={Social}
                            alt="imagen 1"
                        />
                    </div>
